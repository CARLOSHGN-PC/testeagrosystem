...
import { canWriteModule } from '../../utils/accessControl';
  ...
  return (
    <div className="min-h-full bg-[#030916] px-4 py-5 text-white sm:px-6 xl:px-8 2xl:px-10">
      ...
      <div className="mb-6 flex flex-wrap items-center gap-2 rounded-2xl border border-[#1a2233] bg-[#07101d] p-2">
        <button type="button" onClick={() => setActiveTab('geral')} className={`rounded-xl px-4 py-2 text-sm font-semibold transition ${activeTab === 'geral' ? 'bg-[#d4aa4a] text-[#101827]' : 'bg-transparent text-[#cbd6ea] hover:bg-white/5'}`}>Dados Colheita</button>
        <button type="button" onClick={() => setActiveTab('fechamentoOc')} className={`rounded-xl px-4 py-2 text-sm font-semibold transition ${activeTab === 'fechamentoOc' ? 'bg-[#d4aa4a] text-[#101827]' : 'bg-transparent text-[#cbd6ea] hover:bg-white/5'}`}>Talhões Fechados</button>
      </div>
