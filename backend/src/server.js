...
// Rotas de sincronização/apontamentos precisam vir antes das rotas agro genéricas.
// Assim /api/postgres/agro/apontamentos não cai no fallback 404 nem no middleware errado.
app.use('/api/postgres/agro', syncPostgresRoutes);
