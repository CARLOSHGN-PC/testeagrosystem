...
export const normalizeEnabledModules = (modules = {}) => {
  ...
  if ((modules || {}).dashboard_entrada_cana === undefined && normalized.dashboards === true) {
    normalized.dashboard_entrada_cana = true;
  }
  if ((modules || {}).dashboard_talhoes_fechados === undefined && normalized.dashboards === true) {
    normalized.dashboard_talhoes_fechados = true;
  }
  if ((modules || {}).dados_dashboard_colheita === undefined && normalized.dados_dashboard === true) {
    normalized.dados_dashboard_colheita = true;
  }
  if ((modules || {}).dados_dashboard_talhoes_fechados === undefined && normalized.dados_dashboard === true) {
  ...
  if (normalized.apontamentos_broca === true || normalized.apontamentos_perda === true || normalized.apontamentos_complexo_murcha === true) {
    normalized.lancamentos = true;
  }
